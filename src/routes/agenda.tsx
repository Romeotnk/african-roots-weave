  ...
  return (
    <>
      <HeroSection
        ...
        subtitle="Webinaires, formations, salons et portes ouvertes partout en Afrique et en ligne."
        size="md"
      />
        ...
        <div className="container-iwosan">
          <div className="flex items-center justify-between flex-wrap gap-3 mb-8">
            ...
            <div className="flex bg-white border border-[var(--brand-border)] rounded-full p-1">
              <button className="px-4 py-1.5 rounded-full bg-[var(--brand-primary)] text-white text-[13px] font-semibold">
                Liste
              </button>
              <button className="px-4 py-1.5 text-[13px] font-semibold text-[var(--color-text-secondary)]">
                Calendrier
              </button>
            </div>
          </div>
          <div className="space-y-4">
            <h3 className="text-[12px] uppercase tracking-[0.12em] font-bold text-[var(--color-text-muted)] mt-2">
              Juin 2026
            </h3>
            {events.map((e) => (
