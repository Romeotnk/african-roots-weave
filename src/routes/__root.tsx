  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Cette page n'existe pas ou a �t� d�plac�e.</p>
        <div className="mt-6">
          <Link to="/" className="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90">Retour � l'accueil</Link>
        </div>
      </div>
    </div>
  );
    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button onClick={() => { router.invalidate(); reset(); }} className="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90">R�essayer</button>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "IWOSAN - Le savoir m�dical africain, document� et vivant" },
      { name: "description", content: "Plateforme panafricaine �ditoriale, scientifique et communautaire d�di�e � la m�decine traditionnelle, aux plantes m�dicinales et aux cultures de gu�rison africaines." },
      { name: "author", content: "Iwosan" },
      { property: "og:title", content: "IWOSAN - Le savoir m�dical africain, document� et vivant" },
      { property: "og:description", content: "Plateforme panafricaine �ditoriale, scientifique et communautaire d�di�e � la m�decine traditionnelle, aux plantes m�dicinales et aux cultures de gu�rison africaines." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "IWOSAN - Le savoir m�dical africain, document� et vivant" },
      { name: "twitter:description", content: "Plateforme panafricaine �ditoriale, scientifique et communautaire d�di�e � la m�decine traditionnelle, aux plantes m�dicinales et aux cultures de gu�rison africaines." },
