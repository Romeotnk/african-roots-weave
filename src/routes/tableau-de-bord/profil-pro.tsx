...
function ProfessionalShowcasePage() {
  ...
  const stats = useMemo(() => [
    ...
    { label: "�v�nements", value: `${upcomingCount}`, icon: CalendarDays },
            ...
            <div className="mt-8 flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-3xl">
                ...
                <div className="mt-4 flex items-center gap-3">
                  ...
                  {pro.verified && <span className="inline-flex items-center gap-1 rounded-full bg-[var(--brand-gold)] px-3 py-1 text-[12px] font-bold text-white"><CheckCircle2 size={14} /> V�rifi�</span>}
                </div>
              </div>
              <div className="rounded-[24px] border border-white/10 bg-white/10 p-5 backdrop-blur">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-[13px] text-white/75">Administrez votre visibilit� et vos r�servations.</p>
                  </div>
                </div>
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_340px]">
            <div className="space-y-6">
              <section className="rounded-[24px] border border-[var(--brand-border-light)] bg-white p-6">
                <p className="font-mono text-[12px] uppercase tracking-[0.18em] text-[var(--brand-primary)]">� PROPOS</p>
                <p className="mt-4 text-[15px] leading-8 text-[var(--color-text-secondary)]">{pro.bio} Cette vitrine est pens�e pour mettre en avant votre expertise, vos services, vos produits et vos actualit�s dans un format premium orient� conversion et confiance.</p>
              </section>

              <section className="rounded-[24px] border border-[var(--brand-border-light)] bg-white p-6">
                <p className="font-mono text-[12px] uppercase tracking-[0.18em] text-[var(--brand-primary)]">ACTIVIT� R�CENTE</p>
                <div className="mt-4 grid gap-4 md:grid-cols-2">
                  <div className="rounded-2xl bg-[var(--brand-primary-subtle)] p-4">
                    <p className="text-[13px] font-semibold text-[var(--brand-primary)]">Produits publi�s</p>
            ...
            <aside className="space-y-4 rounded-[24px] border border-[var(--brand-border-light)] bg-white p-6 lg:sticky lg:top-24 h-fit">
              ...
              <Link to="/tableau-de-bord/mes-produits" className="block rounded-full border border-[var(--brand-border)] px-4 py-3 text-center font-semibold">G�rer mes produits</Link>
              ...
              <div className="rounded-2xl bg-[var(--brand-surface-alt)] p-4">
                <p className="font-mono text-[12px] uppercase tracking-[0.16em] text-[var(--color-text-muted)]">R�SUM�</p>
                <p className="mt-2 text-[14px] text-[var(--color-text-secondary)]">Vous pouvez maintenant g�rer votre pr�sence publique � partir de cette page vitrine et renvoyer les visiteurs vers votre profil annuaire.</p>
              </div>
            </aside>
          </div>
        </section>
