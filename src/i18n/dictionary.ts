...
export const dict: Record<string, string> = {
  ...
  "Protocoles de préparation et dosage clinique": "Preparation protocols and clinical dosing",
  "Accompagnement périnatal selon les rites Sawa": "Perinatal support according to Sawa rites",
  "Ethnobotanique de terrain : méthodologie": "Field ethnobotany: methodology",
  ...
  "L'ebook est-il téléchargeable plusieurs fois ?": "Can the eBook be downloaded multiple times?",
  ...
  // ---------- Data: events ----------
  "Webinaire — Pharmacopée et diabète type 2": "Webinar — Pharmacopoeia and type-2 diabetes",
  WEBINAIRE: "WEBINAR",
  FORMATION: "COURSE",
  SALON: "FAIR",
  "En ligne": "Online",
  ...
  "Salon Panafricain de la Médecine Traditionnelle": "Pan-African Traditional Medicine Fair",
  ...
  "Webinaire — Rites de guérison et santé mentale": "Webinar — Healing rites and mental health",
  ...
  // ---------- Data: products ----------
  "Tisane post-partum — Mélange Kinkéliba & Moringa": "Post-partum tea — Kinkeliba & Moringa blend",
  "Consultation phytothérapie diabète — 60 min": "Diabetes phytotherapy consultation — 60 min",
  "Beurre de karité brut — Soin dermatologique 250g": "Raw shea butter — Skincare 250g",
  "Ebook — Atlas de 80 plantes médicinales sahéliennes":
    "eBook — Atlas of 80 Sahelian medicinal plants",
  "Huile essentielle de Kinkéliba — 30ml": "Kinkeliba essential oil — 30ml",
  "Formation — Préparation des décoctions traditionnelles":
    "Course — Preparing traditional decoctions",
  "Baume rebouteux — Entorses & douleurs musculaires": "Bonesetter's balm — Sprains & muscle pain",
  "Programme nutrition diabète — 12 semaines": "Diabetes nutrition programme — 12 weeks",
  ...
  Lactation: "Lactation",
  "Aromathérapeute — Huiles essentielles africaines": "Aromatherapist — African essential oils",
  Dakar: "Dakar",
  Sénégal: "Senegal",
